...
export interface LeaveGroupRule {
  id: string;
  leaveTypeId: string;
  annualQuota: number;
...
export const leaveGroups: LeaveGroup[] = [
  {
...
export const leaveLedger: LeaveLedgerEntry[] = [
...
export function getLeaveType(id: string) { return leaveTypes.find(lt => lt.id === id); }
export function getLeaveGroup(id: string) { return leaveGroups.find(lg => lg.id === id); }
export function getEmployeeBalances(employeeId: string) { return leaveBalances.filter(b => b.employeeId === employeeId); }
export function getEmployeeRequests(employeeId: string) { return leaveRequests.filter(r => r.employeeId === employeeId); }
export function getEmployeeLedger(employeeId: string) { return leaveLedger.filter(l => l.employeeId === employeeId); }
